# <%= lodash.slugify(lodash.humanize(name)) %>

This project was generated with the [Mongolia Generator](https://github.com/khawajaumarfarooq/generator-mongolia) version <%= rootGeneratorVersion() %>.
